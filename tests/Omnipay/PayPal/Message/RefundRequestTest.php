...
class RefundRequestTest extends TestCase
{
    ...
    {
        return array(
            'Partial' => array(RefundRequest::TYPE_PARTIAL, '1.23'),
            'Full' => array(RefundRequest::TYPE_FULL, '0'),
        );
    }
}
