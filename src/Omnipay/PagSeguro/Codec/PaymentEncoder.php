...
use Omnipay\PagSeguro\ValueObject\Address;
...
class PaymentEncoder
{
     ...
     * @param \Omnipay\PagSeguro\ValueObject\PaymentRequest $request
     *
     * @return string
     */
    ...
    /**
     * @param array $data
     * @param Omnipay\PagSeguro\ValueObject\Item $item
     */
    ...
    /**
     * @param array $data
     * @param Omnipay\PagSeguro\ValueObject\Address $address
     */
